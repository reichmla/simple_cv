...
\leftheader{%
	\faLinkedin {\href{https://www.linkedin.com/in/profile/}{in/profile}} \hfill \faEnvelope[regular] {\href{mailto:jane@doe.com}{jane@doe.com}} \hfill \faIcon{mobile-alt} {\href{tel:+123456789}{+123456789}} \par
	 \vspace{0.4cm}
  {\LARGE\sffamily Bunny Doe} \par
   \vspace{0.05cm}

 \vspace{0.2cm}
\textcolor{TextColor}{Hop into my world of professional excellence! Like a bunny with a mission, I bounce from challenge to challenge with boundless energy and fluffy determination. Whether it's carrots or complex problems, I approach everything with enthusiasm and a twitch of innovation.}
}
\headerscale{0.95}
